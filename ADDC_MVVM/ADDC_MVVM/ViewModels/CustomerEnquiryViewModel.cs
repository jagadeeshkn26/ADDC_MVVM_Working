...
namespace ADDC_MVVM.ViewModels
{
    ...
    public class CustomerEnquiryViewModel : ViewModelBase
    {
        public ICommand SubmitCommand { get; set; }
		public ICommand OnTapMenu { get; set; }
		 MyAccountDetails authRes4;
       ...
       private List<SystemElement> SEList;
		...
		public ObservableCollection<SystemElement> ACCElementList { get; set; }
       ...
       // public ICommand SubmitEnquiry { get; set; }
        ...
        public CustomerEnquiryViewModel() {
			...
			ACCElementList = new ObservableCollection<SystemElement>();
            ...
            emailForEnquiry = Application.Current.Properties["EmailID"].ToString();
			 ...
			 if(authRes4 == null)
			{
				authRes4 = new MyAccountDetails();
				authRes4 = Application.Current.Properties["authRes4"] as MyAccountDetails;
			}
			int i = 0;
			foreach (var Accnum in authRes4.AccountDetails)
			{
				EnquiryType = new SystemElement();
				EnquiryType.SystemElementName = Accnum.AccountID;

				SEList.Add(EnquiryType);
				ACCElementList.Add(EnquiryType);
				SESelectedValue = 0;
				EnquiryType = null;
			}
		...
		private async void YesBtn()
		{
			throw new NotImplementedException();
		}

		private async void NoBtn()
		{
			throw new NotImplementedException();
		}
            ...
            try
            {
                ...
                using (var client = new HttpClient(new NativeMessageHandler()))
                {
                   ...
                   // string User = Application.Current.Properties["UserID"].ToString();
                    ...
                    EnquirySubmitReq parameter = new EnquirySubmitReq() {Description  = msgForEnquiry , Name = User ,RelatedToPremise = "0", EmailID = emailForEnquiry,
                                                 AccountNumber = AccountNum , PersonID = perosnID , EnquiryType = enquiryType, AuthenticationToken = "AuthenticationToken_0"};
